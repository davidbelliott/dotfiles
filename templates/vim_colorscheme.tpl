...
if has("nvim")
  ...
  let g:terminal_color_9 =  "#{{base09}}"
  let g:terminal_color_10 = "#{{base01}}"
  let g:terminal_color_11 = "#{{base02}}"
  let g:terminal_color_12 = "#{{base04}}"
  let g:terminal_color_13 = "#{{base06}}"
  let g:terminal_color_14 = "#{{base0F}}"
